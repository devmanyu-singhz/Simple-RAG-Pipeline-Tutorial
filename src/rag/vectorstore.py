...
class FaissVectorStore:
    ...
    def add_embeddings(self, embeddings:np.ndarray, metadatas:List[Any] = None):
        ...
        print(f"Added {embeddings.shape[0]} to faiss vector index")
    ...
    def load(self):
        ...
        print(f"Loaded faiss index and metadata to {self.persist_dir}")
    ...
    def query(self, query_text:str, top_k:int=5):
        print(f"Quering vector store for: {query_text}")
